...
(function () {
  ...
  // Pause all CSS animations when tab is hidden to save GPU resources
  function initVisibilityOptimizer() {
    const style = document.createElement('style');
    style.id = 'ml-visibility-style';
    document.head.appendChild(style);

    document.addEventListener('visibilitychange', () => {
      style.textContent = document.hidden
